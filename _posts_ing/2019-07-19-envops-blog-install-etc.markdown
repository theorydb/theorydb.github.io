---
layout: post
title:  "[Jekyll Blog] 블로그 설치 마감처리 및 그 외 사소한 것들"
subtitle:   "기타 마감처리"
categories: envops
tags: envops blog github pages jekyll finishing etc  
comments: true
---


## 개요
> 블로그 설치 마무리 단계입니다. 문제를 해결할 수 있는 Tip을 다룬다.  
  
- 목차
	- [The 'gems' configuration option has been renamed to 'plugin 지킬 보안 경고](#disqus란) 
	- [마크다운에 이미지, 수식(라텍스) 연동하기](#disqus-회원가입)
	- [rss feed 연동 플러그인 없이 Jekyll RSS Feed 만들기](#disqus-회원가입)
	- [마크다운 에디터 설치, Stackedit, Marxico등 - vs 플러그인 인식, 단축키 플러그인 설치](#disqus-회원가입)
	- [rejected master -> master (fetch first)](#disqus-회원가입)
