---
layout: post
title:  "[Jekyll Blog] Git & Jekyll 사용법"
subtitle:   "Git & Jekyll"
categories: envops
...
## 개요
> 포스트 배포에 꼭 필요한 부분만 골라낸 `Git`과 `Jekyll`의 사용법에 대해서 배워봅시다.  
...
* __Git을 꼭 써야하나요?__  
>여러분이 생각하는 최종파일은 그 최종파일이 아니다.  
![그림1](https://theorydb.github.io/assets/img/fun/final-real.jpg)

분명히 그동안의 문서를 잘 수정반영하여 최종파일을 만들었건만, 여러분이 생각하는 그 최종파일은 최종파일이 아닌 경험..누구나 가지고 계실것이다. 문제는 나중에 보면 진짜 최종이 뭔지 모른다. 
