...
* __모든것의 `수학화`__    
  ...
  여기서 우리식 수학 교육의 병폐를 느꼈다. x = ab 라는 식을 우리식 교육과정을 받은 대부분의 이들은 대수적으로 받아들일 것이다. 하지만 요즘 어린 아이들을 대상으로 하는 사교육 서적을 들춰보면 기하학적 해석이 담겨있다. 위 식은 a를 가로, b를 세로로 판단하면 사각형이 되기 때문이다. 즉 `곱셈은 사각형`이다.
