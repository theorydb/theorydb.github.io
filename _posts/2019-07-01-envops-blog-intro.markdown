...
* __(Who) 누가 읽을까요?__
~~아무도 없을지도 모른다.ㅎㅎㅎ~~ 하지만 한번 생각해봐야 포스팅하는 문체, 전개방식을 선택하게 되고, 역시 플랫폼 선정 시 여러번 삭제했다 만드는 등 시행착오를 줄이게 된다.
...
## (How-To) 어디에 만들것인가? 어떤 플랫폼과 기술을 활용할까?
...
## 다른 플랫폼 및 기술을 활용할 사람들을 위한 참고사이트 
